...
public class GeminiTest {
    ...
    public static void main(String[] args) {
        String message = "Write a story about a magic backpack.(dont add any new line or inverted commas or anything that usses a backslash for formatting, just write plain text (but do include headings if needed))"; // Example message
